...
function fixWebmDuration(blob) {
    return __awaiter(this, void 0, void 0, function () {
        var decoder, reader, readstream, readerBlob, _a, done, value, refinedMetadataBuf, refinedMetadataBlob, firstPartBlobWithoutMetadata, finalBlob;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    decoder.decode(value).forEach(function (elm) {
                        reader.read(elm);
                    });
                    value = null;
                    return [3 /*break*/, 1];
